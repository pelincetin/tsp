...
public class Display extends JFrame {
  ...
  JLabel lblNearestneighbordistance;
  JLabel lblNearestNeighbor;
  JLabel lblNearestneighbortime; 
  JLabel lblBruteforcetime;
  JLabel lblBruteforcedistance;
  ...
  public Display() {
    ...
    lblNearestneighbordistance = new JLabel("");
    ...
    lblNearestneighbortime = new JLabel("");
    ...
    lblBruteforcedistance = new JLabel("");
